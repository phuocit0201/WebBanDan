    <!-- head-->
    <?php 
        require_once "./views/client/include/head.php";
    ?>
    <!--/head-->
...
<body>
	...
	<!-- header-->
    <?php 
        require_once "./views/client/include/header.php";
    ?>
	<!--/header-->

	<!-- gọi trang con -->
    <?php 
        require_once "./views/client/cpanel/".$data["folder"]."/".$data["file"].".php";
    ?>
    <!--/gọi trang con -->
	...
	<!--Footer-->
    <?php 
        require_once "./views/client/include/footer.php";
    ?>
	<!--/Footer-->
</body>
<script>
